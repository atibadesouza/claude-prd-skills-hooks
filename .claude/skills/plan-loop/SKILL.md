...
8. **Scope baseline captured** — write the `## Scope Baseline` section into the plan (see "Scope-delta tracking" below) **before** round 1. Without it there is nothing to diff the loop's revisions against, and drift becomes invisible.
